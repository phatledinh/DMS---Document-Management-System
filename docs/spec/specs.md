...
- Virus/Malware scan nâng cao (Phase 2 hoặc Production hardening)
...
| PDF (Scanned) | `.pdf` | 🔮 Phase 2 | ✅ | Cần OCR (Tesseract) để search nội dung |
...
| Ảnh | `.jpg`, `.png`, `.tiff` | 🔮 Phase 2 | ✅ | Preview trực tiếp, OCR ở Phase 2 |
...
| Nội dung độc hại | Virus/Malware scan nâng cao thuộc Phase 2 hoặc Production hardening |

---

## 6. Search Engine Requirements

Tìm kiếm là chức năng cốt lõi và được thực thi bởi Elasticsearch ngay từ Phase 1.
...
| 7 | **Scalability** | Kiến trúc Elasticsearch-first, cho phép mở rộng cluster search và S3/MinIO ở Phase 2 |
