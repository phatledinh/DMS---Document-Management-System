...
function getSelectedMenuKey(pathname) {
    if (pathname.startsWith("/admin/upload-admin"))
...
export default function AppLayout({ children }) {
    ...
    return (
        <Layout
            className={`${styles.shell} ${isAdmin ? styles.adminShell : ""}`}
        >
            {isAdmin && (
                            ...
                            {isAdmin ? (
                                ...
                                <Dropdown
                                    ...
                                    popupRender={() => (
                                        <div className={styles.userDropdown}>
                                            ...
                                            <div
                                                className={
                                                    styles.userDropdownSectionTitle
                                                }
                                            >
                                                KHU VỰC NGƯỜI DÙNG
                                            </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <DownOutlined
                                            className={styles.userPillChevron}
                                        />
                                    </button>
                                </Dropdown>
                            )}
